    ...
    <div className="space-y-6 animate-fadeIn pb-16">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-5 sm:p-6 rounded-3xl border border-slate-200 shadow-sm">
        ...
        <button
          ...
          className="px-4 py-2.5 rounded-xl bg-rose-600 hover:bg-rose-500 text-white font-bold text-xs shadow-md shadow-rose-900/20 transition flex items-center gap-2 self-start md:self-auto"
        >
                ...
                <div className="mt-4 space-y-1.5 text-xs text-slate-600">
                  ...
                  {sup.contactEmail && (
                    <div className="flex items-center gap-2">
                      ...
                      <a href={`mailto:${sup.contactEmail}`} className="text-slate-600 hover:text-rose-600 truncate">
                        {sup.contactEmail}
                      </a>
                    </div>
                  )}
                  {sup.contactPhone && (
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-mono text-slate-600">{sup.contactPhone}</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              <tbody className="divide-y divide-slate-100 text-slate-800">
                {filteredSuppliers.map((sup) => (
                  <tr key={sup.id} className="hover:bg-slate-50/80 transition">
                    ...
                    <td className="p-4">
                      <span className="font-bold text-rose-600">{sup.category}</span>
                    </td>
                    ...
                    <td className="p-4 text-right">
                      <Link
                        href="/procurement/queue"
                        className="px-3 py-1.5 rounded-xl bg-slate-100 hover:bg-slate-200 font-bold text-slate-800 text-xs transition"
                      >
                        Source
                      </Link>
                    </td>
