...
export default function ProcurementTrackingPage() {
  ...
  return (
    <div className="space-y-6 animate-fadeIn pb-16">
      ...
      {/* Shipment Table List View (Full Width) */}
      {!selectedReqId || !activeReq ? (
              ...
              <table className="w-full text-left text-xs text-slate-600">
                <thead className="bg-slate-50 text-[10px] uppercase font-bold text-slate-500 border-b border-slate-200 tracking-wider">
                  <tr>
                    ...
                    <th className="py-3 px-4">Ref # &amp; Requested Part</th>
                    <th className="py-3 px-4">Vehicle &amp; Customer</th>
                    <th className="py-3 px-4">Freight Mode</th>
                      ...
                      return (
                        ...
                        >
                          <td className="py-3.5 px-4 font-mono font-bold text-blue-700">
                            <div>{req.shipment?.trackingNumber || "AW-729481"}</div>
                          ...
                          <td className="py-3.5 px-4">
                            ...
                            <span className="text-slate-800 font-semibold">{req.part.partName}</span>
                          </td>
                          <td className="py-3.5 px-4">
                          ...
                          <td className="py-3.5 px-4">
                            <div className="inline-flex items-center gap-1 text-[11px] font-bold px-2.5 py-1 rounded-full bg-slate-100 text-slate-700">
                              {isAir ? (
                                <>
                          ...
                          <td className="py-3.5 px-4 text-right">
                            <button
                              ...
                              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs shadow-sm shadow-blue-900/10 transition"
                            >
        ...
        /* Full-Width Shipment Details View */
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-sm space-y-6">
                  ...
                  {steps.map((st, idx) => {
                    ...
                    return (
                      <div key={st.label} className="relative z-10 flex flex-col items-center group">
                        ...
                        <span
                          className={`hidden md:block text-[11px] font-bold mt-2 text-center max-w-[90px] leading-tight ${
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              <div className="p-5 rounded-2xl bg-slate-50 border border-slate-100 space-y-2">
                ...
                <div className="flex items-center gap-2 font-mono font-bold text-blue-700 text-sm">
            ...
            <div className="p-5 rounded-2xl bg-slate-50 border border-slate-100 text-xs space-y-2">
              <div className="flex items-center justify-between">
